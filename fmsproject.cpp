...
//global variables
double clocktime, meanInterArrivalTime, meanServiceTime1, meanServiceTime2, meanServiceTime3, lastEventTime1, lastEventTime2, lastEventTime3, totalBusy1, totalBusy2, totalBusy3, maxQueueLength12, maxQueueLength3, sumResponseTime;
...
void processArrival(Event evt){
    ...
    if(evt.get_serverChosen() == "s1" && numberInService1==0){
        ...
        totalBusy1+=(clocktime - lastEventTime1-1);
        totalBusy2+=(clocktime - lastEventTime2-1);
    }
...
void processDeparture1(Event evt)
{
    ...
    else totalBusy3+=(clocktime - lastEventTime3 - 1);
    //adjust max queue length statistics
...
void processDeparture3(Event evt)
{
    ...
    sumResponseTime += Response;
    totalBusy3+= (clocktime -lastEventTime3-1);
    numberOfDepartures3++;
    lastEventTime3= clocktime;
}
